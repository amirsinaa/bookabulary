...
export const VocabularyCard = ({ data, ...props }) => {
  ...
  return (
    <div className="flex flex-col justify-center p-4 m-2 bg-white dark:bg-lime-700 rounded-lg md:p-10 md:w-5/12 min-h-24 drop-shadow-md grow hover:cursor-pointer" {...props}>
